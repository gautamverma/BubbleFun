...
public class ScreenConst {
	...
	// Common UI
	public static final int NEXT_X = 235;
	public static final int NEXT_Y = 60;
	
	public static final int LEVEL_X = 235;
	public static final int LEVEL_Y = 230;
	
	public static final int LEVEL_VALUE_X = 235;
	public static final int LEVEL_VALUE_Y = 260;
	
	public static final int SCORE_X = 235;
	public static final int SCORE_Y = 320;
	
	public static final int SCORE_VALUE_X = 235;
	public static final int SCORE_VALUE_Y = 350;
	
	public static final int LINES_X = 235;
	public static final int LINES_Y = 410;
	
	public static final int LINES_VALUE_X = 235;
	public static final int LINES_VALUE_Y = 440;
	
	
	// Start
	public static final int TAP_TO_START_X = 50;
	public static final int TAP_TO_START_Y = 180;

	// Paused
	public static final int RESUME_X = 48;
	public static final int RESUME_Y = 180;
	
	public static final int QUIT_X = 91;
	public static final int QUIT_Y = 240;
	
	// Stopped
	public static final int YOUR_SCORE_X = 30;
	...
	public static final int MSG_FAIL_Y = 206;
